...
import static com.checkitout.backend.auth.enumstorage.messages.JwtMessages.ACCESS_TOKEN;
import static com.checkitout.backend.auth.enumstorage.messages.JwtMessages.REFRESH_TOKEN;
import static com.checkitout.backend.enumstorage.messages.Messages.INVALID;
import static com.checkitout.backend.enumstorage.messages.Messages.NOT_FOUND;
...
//        memberRepository.save(member);
    ...
    public String[] reissueJwts(String email, String refreshToken) throws NoSuchMemberException, IllegalArgumentException, NoSuchDeviceTokenException, NoSuchRefreshTokenInDBException, JWTVerificationException {
//        , String deviceToken)
...
//    }
     ...
     * 헤더를 가져온 후 "Bearer"를 삭제(""로 replace)
     */
    public String validateAndExtractEmailFromRefreshToken(String refreshToken) throws InvalidRefreshTokenException {
        try {
            // refreshToken을 검증한다.
